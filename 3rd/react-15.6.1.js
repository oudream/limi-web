 ...
 */
        ...
        let _prodInvariant = _dereq_(25);

        let invariant = _dereq_(30);
 ...
 */
        ...
        let _assign = _dereq_(32);

        let ReactBaseClasses = _dereq_(4);
        let ReactChildren = _dereq_(5);
        let ReactDOMFactories = _dereq_(8);
        let ReactElement = _dereq_(9);
        let ReactPropTypes = _dereq_(14);
        let ReactVersion = _dereq_(17);

        let createReactClass = _dereq_(20);
        let onlyChild = _dereq_(24);
        ...
        if ('development' !== 'production') {
            ...
            let ReactElementValidator = _dereq_(11);
 ...
 */
        ...
        let ReactNoopUpdateQueue = _dereq_(12);

        let canDefineProperty = _dereq_(18);
        let emptyObject = _dereq_(29);
        let invariant = _dereq_(30);
        let lowPriorityWarning = _dereq_(23);
 ...
 */
        ...
        let PooledClass = _dereq_(2);
        let ReactElement = _dereq_(9);

        let emptyFunction = _dereq_(28);
        let traverseAllChildren = _dereq_(26);

        let twoArgumentPooler = PooledClass.twoArgumentPooler;
        let fourArgumentPooler = PooledClass.fourArgumentPooler;
 ...
 */
        function forEachChildren(children, forEachFunc, forEachContext) {
            ...
            let traverseContext = ForEachBookKeeping.getPooled(forEachFunc, forEachContext);
 ...
 */
      ...
      keyPrefix + (mappedChild.key && (!child || child.key !== mappedChild.key) ? escapeUserProvidedKey(mappedChild.key) + '/' : '') + childKey);
        ...
        function mapIntoWithKeyPrefixInternal(children, array, prefix, func, context) {
            ...
            let traverseContext = MapBookKeeping.getPooled(array, escapedPrefix, func, context);
 ...
 */
        ...
        let ReactCurrentOwner = _dereq_(7);

        let invariant = _dereq_(30);
        let warning = _dereq_(31);

        function isNative(fn) {
  // Based on isNative() from Lodash
            let funcToString = Function.prototype.toString;
            let hasOwnProperty = Object.prototype.hasOwnProperty;
            let reIsNative = RegExp('^' + funcToString
  ...
  // Remove hasOwnProperty from the template to make it generic
            ...
            try {
            let source = funcToString.call(fn);
...
Set.prototype != null && typeof Set.prototype.keys === 'function' && isNative(Set.prototype.keys);
  ...
  // https://github.com/facebook/react/pull/7232
            let getKeyFromID = function(id) {
            return '.' + id;
        };
            let getIDFromKey = function(key) {
        ...
        function describeID(id) {
            let name = ReactComponentTreeHook.getDisplayName(id);
        ...
        var ReactComponentTreeHook = {
            ...
            for (let i = 0; i < nextChildIDs.length; i++) {
                ...
                let nextChild = getItem(nextChildID);
      ...
      // Should only be used for testing.
            ...
            let source = element != null ? element._source : null;
            return source;
        },
            getText: function(id) {
            let element = ReactComponentTreeHook.getElement(id);
            ...
            try {
                ...
                while (id) {
                    ...
                    let ownerID = ReactComponentTreeHook.getOwnerID(id);
                    let ownerName = ownerID ? ReactComponentTreeHook.getDisplayName(ownerID) : null;
                    let source = element && element._source;
                    stack.push({
                        name: ownerName,
 ...
 */
    ...
    let REACT_ELEMENT_TYPE = _dereq_(10);
 ...
 */
    ReactElement.createFactory = function(type) {
        let factory = ReactElement.createElement.bind(null, type);
 ...
 */
  ...
  // Original props are copied
        let props = _assign({}, element.props);
 ...
 */
    ...
    let ReactCurrentOwner = _dereq_(7);
    let ReactComponentTreeHook = _dereq_(6);
    let ReactElement = _dereq_(9);

    let checkReactTypeSpec = _dereq_(19);

    let canDefineProperty = _dereq_(18);
    let getIteratorFn = _dereq_(21);
    let warning = _dereq_(31);
    let lowPriorityWarning = _dereq_(23);
 ...
 */
    function validateExplicitKey(element, parentType) {
        ...
        let memoizer = ownerHasKeyUseWarning.uniqueKey || (ownerHasKeyUseWarning.uniqueKey = {});
 ...
 */
    ...
    // succeed and there will likely be errors in render.
            if (!validType) {
                if (typeof type !== 'function' && typeof type !== 'string') {
                    ...
                    let currentSource = props !== null && props !== undefined && props.__source !== undefined ? props.__source : null;
            ...
            let element = ReactElement.createElement.apply(this, arguments);
    ...
    // fixed, the key warnings will appear.)
        ...
        createFactory: function(type) {
            let validatedFactory = ReactElementValidator.createElement.bind(null, type);
    // Legacy hook TODO: Warn if this is accessed
        ...
        cloneElement: function(element, props, children) {
            let newElement = ReactElement.cloneElement.apply(this, arguments);
            for (let i = 2; i < arguments.length; i++) {
 ...
 */
    ...
    let _require = _dereq_(9),
        isValidElement = _require.isValidElement;

    let factory = _dereq_(34);
...
// `version` will be added here by the React module.
    let ReactUMDEntry = _assign(React, {
 ...
 */
        ...
        let ReactPropTypeLocationNames = _dereq_(13);
        let ReactPropTypesSecret = _dereq_(15);
 ...
 */
    ...
    let _require = _dereq_(4),
        Component = _require.Component;

    let _require2 = _dereq_(9),
        isValidElement = _require2.isValidElement;

    let ReactNoopUpdateQueue = _dereq_(12);
    let factory = _dereq_(27);
 ...
 */
    ...
    let emptyObject = _dereq_(29);
    let _invariant = _dereq_(30);

    if ('development' !== 'production') {
        var warning = _dereq_(31);
    }

    let MIXINS_KEY = 'mixins';
...
// have .name set to the name of the variable being assigned to.
   ...
   */
     ...
     */
        ...
        function validateMethodOverride(isAlreadyDefined, name) {
            let specPolicy = ReactClassInterface.hasOwnProperty(name)
   ...
   */
        function mixSpecIntoComponent(Constructor, spec) {
            if (!spec) {
                if ('development' !== 'production') {
                    let typeofSpec = typeof spec;
                    let isMixinValid = typeofSpec === 'object' && spec !== null;
      ...
      'ReactClass: You\'re attempting to ' +
        'use a component as a mixin. Instead, just use a regular object.'
            ...
            let autoBindPairs = proto.__reactAutoBindPairs;
    ...
    // mixins are listed before or after these methods in the spec.
        ...
        // 2. Overridden methods (that were mixed in).
          ...
          spec.autobind !== false;
                    ...
                    if (shouldAutoBind) {
                        ...
                        if (isAlreadyDefined) {
                            let specPolicy = ReactClassInterface[name];
        ...
        function mixStaticSpecIntoComponent(Constructor, statics) {
            ...
            for (let name in statics) {
                let property = statics[name];
                if (!statics.hasOwnProperty(name)) {
                    continue;
                }

                let isReserved = name in RESERVED_SPEC_KEYS;
                _invariant(
        !isReserved,
        ...
        name
                ...
                let isInherited = name in Constructor;
                _invariant(
        !isInherited,
   ...
   */
        function createMergedResultFunction(one, two) {
            return function mergedResult() {
                ...
                let b = two.apply(this, arguments);
                if (a == null) {
                    return b;
                } else if (b == null) {
                    return a;
   ...
   */
        function bindAutoBindMethod(component, method) {
            let boundMethod = method.bind(component);
            if ('development' !== 'production') {
                boundMethod.__reactBoundContext = component;
                boundMethod.__reactBoundMethod = method;
                boundMethod.__reactBoundArguments = null;
                let componentName = component.constructor.displayName;
                let _bind = boundMethod.bind;
        ...
        // let's warn.
              ...
              componentName
                    ...
                    let reboundMethod = _bind.apply(boundMethod, arguments);
   ...
   */
        function bindAutoBindMethods(component) {
            let pairs = component.__reactAutoBindPairs;
            for (let i = 0; i < pairs.length; i += 2) {
                let autoBindKey = pairs[i];
                let method = pairs[i + 1];
                component[autoBindKey] = bindAutoBindMethod(component, method);
            }
        }

        let IsMountedPreMixin = {
            componentDidMount: function() {
                this.__isMounted = true;
            },
        };

        let IsMountedPostMixin = {
   ...
   */
     ...
     */
        ...
        let ReactClassComponent = function() {};
        _assign(
 ...
 */
    ...
    let ReactPropTypesSecret = _dereq_(36);
    let checkPropTypes = _dereq_(33);
