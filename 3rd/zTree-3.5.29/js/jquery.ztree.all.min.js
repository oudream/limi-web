 ...
 */
(function(m) {
    let p, q, r, o={event: {CHECK: 'ztree_check'}, id: {CHECK: '_check'}, checkbox: {STYLE: 'checkbox', DEFAULT: 'chk', DISABLED: 'disable', FALSE: 'false', TRUE: 'true', FULL: 'full', PART: 'part', FOCUS: 'focus'}, radio: {STYLE: 'radio', TYPE_ALL: 'all', TYPE_LEVEL: 'level'}}, v={check: {enable: !1, autoCheckTrigger: !1, chkStyle: o.checkbox.STYLE, nocheckInherit: !1, chkDisabledInherit: !1, radioType: o.radio.TYPE_LEVEL, chkboxType: {Y: 'ps', N: 'ps'}}, data: {key: {checked: 'checked'}}, callback: {beforeCheck: null, onCheck: null}}; p=function(c,
a) {
        if (a.chkDisabled===!0) return !1; let b=g.getSetting(c.data.treeId), d=b.data.key.checked; if (k.apply(b.callback.beforeCheck, [b.treeId, a], !0)==!1) return !0; a[d]=!a[d]; e.checkNodeRelation(b, a); d=n(a, j.id.CHECK, b); e.setChkClass(b, d, a); e.repairParentChkClassWithSelf(b, a); b.treeObj.trigger(j.event.CHECK, [c, b.treeId, a]); return !0;
    }; q=function(c, a) {
        if (a.chkDisabled===!0) return !1; let b=g.getSetting(c.data.treeId), d=n(a, j.id.CHECK, b); a.check_Focus=!0; e.setChkClass(b, d, a); return !0;
    }; r=function(c, a) {
        if (a.chkDisabled===
!0) return !1; let b=g.getSetting(c.data.treeId), d=n(a, j.id.CHECK, b); a.check_Focus=!1; e.setChkClass(b, d, a); return !0;
    }; m.extend(!0, m.fn.zTree.consts, o); m.extend(!0, m.fn.zTree._z, {tools: {}, view: {checkNodeRelation: function(c, a) {
        let b, d, h, i=c.data.key.children, l=c.data.key.checked; b=j.radio; if (c.check.chkStyle==b.STYLE) {
            let f=g.getRadioCheckedList(c); if (a[l]) {
                if (c.check.radioType==b.TYPE_ALL) {
                    for (d=f.length-1; d>=0; d--) {
                        b=f[d], b[l]&&b!=a&&(b[l]=!1, f.splice(d, 1), e.setChkClass(c, n(b, j.id.CHECK, c), b), b.parentTId!=
a.parentTId&&e.repairParentChkClassWithSelf(c, b));
                    }f.push(a);
                } else {
                    f=a.parentTId?a.getParentNode():g.getRoot(c); for (d=0, h=f[i].length; d<h; d++)b=f[i][d], b[l]&&b!=a&&(b[l]=!1, e.setChkClass(c, n(b, j.id.CHECK, c), b));
                }
            ...
            a[l]&&(!a[i]||a[i].length==0||c.check.chkboxType.Y.indexOf('s')>-1)&&e.setSonNodeCheckBox(c, a, !0), !a[l]&&(!a[i]||a[i].length==0||c.check.chkboxType.N.indexOf('s')>-1)&&e.setSonNodeCheckBox(c,
...
'_'+i, b=a.check_Focus&&a.chkDisabled!==!0?b+'_'+d.FOCUS:b; return j.className.BUTTON+' '+d.DEFAULT+' '+b;
        ...
        if (c.check.enable&&c.check.chkStyle===j.checkbox.STYLE) {
            for (let b=c.data.key.checked, d=c.data.key.children, h=g.getRoot(c), i=0, l=h[d].length; i<l; i++) {
                let f=h[d][i]; f.nocheck!==!0&&f.chkDisabled!==!0&&(f[b]=a); e.setSonNodeCheckBox(c, f, a);
            }
        }
    }, repairChkClass: function(c, a) {
        if (a&&(g.makeChkFlag(c, a), a.nocheck!==!0)) {
            let b=n(a, j.id.CHECK, c); e.setChkClass(c, b, a);
        }
    }, repairParentChkClass: function(c,
a) {
        if (a&&a.parentTId) {
        let b=a.getParentNode(); e.repairChkClass(c, b); e.repairParentChkClass(c, b);
    }
    }, repairParentChkClassWithSelf: function(c, a) {
    if (a) {
        let b=c.data.key.children; a[b]&&a[b].length>0?e.repairParentChkClass(c, a[b][0]):e.repairParentChkClass(c, a);
    }
}, repairSonChkDisabled: function(c, a, b, d) {
    if (a) {
        let h=c.data.key.children; if (a.chkDisabled!=b)a.chkDisabled=b; e.repairChkClass(c, a); if (a[h]&&d) for (let i=0, l=a[h].length; i<l; i++)e.repairSonChkDisabled(c, a[h][i], b, d);
    }
...
a, b, d) {
    ...
    if (a) {
        let h=c.data.key.children, i=c.data.key.checked, l=n(a, j.id.CHECK, c); d||(d=a); let f=!1; if (a[h]) {
            for (let k=0, m=a[h].length; k<m; k++) {
                let o=a[h][k]; e.setSonNodeCheckBox(c, o, b, d); o.chkDisabled===
!0&&(f=!0);
            }
...
1), b--, d--);
    ...
    if (!c.check.enable||a.nocheck||a.chkDisabled) return null; let b=c.data.key.checked; return {checked: a[b], half: a.halfCheck?a.halfCheck:c.check.chkStyle==j.radio.STYLE?a.check_Child_State===2:a[b]?a.check_Child_State>-1&&a.check_Child_State<2:a.check_Child_State>0};
    ...
    if (!a) return []; for (var d=c.data.key.children, h=c.data.key.checked, b=!b?[]:b, i=0, e=a.length; i<e; i++)a[i].nocheck!==!0&&a[i].chkDisabled!==!0&&a[i][h]!=a[i].checkedOld&&b.push(a[i]), g.getTreeChangeCheckedNodes(c, a[i][d], b); return b;
}, makeChkFlag: function(c, a) {
    if (a) {
        let b=c.data.key.children,
            d=c.data.key.checked, h=-1; if (a[b]) {
                for (let i=0, e=a[b].length; i<e; i++) {
                    let f=a[b][i], g=-1; if (c.check.chkStyle==j.radio.STYLE) {
                        ...
                        if (g=f.nocheck===!0||f.chkDisabled===!0?f.check_Child_State:f.halfCheck===!0?1:f[d]?f.check_Child_State===-1||f.check_Child_State===2?2:1:f.check_Child_State>0?1:0, g===1) {
                            h=1; break;
                        } else if (g===
2&&h>-1&&i>0&&g!==h) {
                            h=1; break;
...
}}}); var m=m.fn.zTree, k=m._z.tools, j=m.consts, e=m._z.view, g=m._z.data, n=k.$; g.exSetting(v); g.addInitBind(function(c) {
...
b);
    ...
    let a=c.target, b=g.getSetting(c.data.treeId), d='', h=null, e='', l=null; if (k.eqs(c.type, 'mouseover')) {
...
k.getNodeMainDom(a).id, e='mouseoutCheck';
    ...
    } else if (k.eqs(c.type, 'click')&&b.check.enable&&k.eqs(a.tagName, 'span')&&a.getAttribute('treeNode'+j.id.CHECK)!==null)d=k.getNodeMainDom(a).id, e='checkNode'; if (d.length>0) {
        switch (h=g.getNodeCache(b, d), e) {
        case 'checkNode':l=p; break; case 'mouseoverCheck':l=q; break; case 'mouseoutCheck':l=r;
        }
    ...
    g.addBeforeA(function(c, a, b) {
        ...
        a.checkNode=function(a, b, c, g) {
            let f=this.setting.data.key.checked; if (a.chkDisabled!==!0&&(b!==!0&&b!==!1&&(b=!a[f]), g=!!g, (a[f]!==b||c)&&!(g&&k.apply(this.setting.callback.beforeCheck, [this.setting.treeId, a], !0)==!1)&&k.uCanDo(this.setting)&&this.setting.check.enable&&
a.nocheck!==!0))a[f]=b, b=n(a, j.id.CHECK, this.setting), (c||this.setting.check.chkStyle===j.radio.STYLE)&&e.checkNodeRelation(this.setting, a), e.setChkClass(this.setting, b, a), e.repairParentChkClassWithSelf(this.setting, a), g&&this.setting.treeObj.trigger(j.event.CHECK, [null, this.setting.treeId, a]);
            ...
            let b=this.setting.data.key.children; return g.getTreeCheckedNodes(this.setting, g.getRoot(this.setting)[b], a!==!1);
        };
        a.getChangeCheckedNodes=function() {
            let a=this.setting.data.key.children; return g.getTreeChangeCheckedNodes(this.setting, g.getRoot(this.setting)[a]);
        ...
        }; let b=a.updateNode; a.updateNode=function(c, g) {
            b&&b.apply(a, arguments); if (c&&this.setting.check.enable&&n(c, this.setting).get(0)&&k.uCanDo(this.setting)) {
                let i=n(c, j.id.CHECK, this.setting); (g==!0||this.setting.check.chkStyle===
j.radio.STYLE)&&e.checkNodeRelation(this.setting, c); e.setChkClass(this.setting, i, c); e.repairParentChkClassWithSelf(this.setting, c);
    ...
    }); let s=e.createNodes; e.createNodes=function(c, a, b, d, g) {
        s&&s.apply(e, arguments); b&&e.repairParentChkClassWithSelf(c, d);
    }; let t=e.removeNode; e.removeNode=function(c, a) {
        let b=a.getParentNode(); t&&t.apply(e, arguments); a&&b&&(e.repairChkClass(c, b), e.repairParentChkClass(c, b));
    }; let u=e.appendNodes; e.appendNodes=function(c, a, b, d, h, i, j) {
        let f=''; u&&(f=u.apply(e, arguments));
 ...
 */
(function(v) {
    var J={event: {DRAG: 'ztree_drag', DROP: 'ztree_drop', RENAME: 'ztree_rename', DRAGMOVE: 'ztree_dragmove'}, id: {EDIT: '_edit', INPUT: '_input', REMOVE: '_remove'}, move: {TYPE_INNER: 'inner', TYPE_PREV: 'prev', TYPE_NEXT: 'next'}, node: {CURSELECTED_EDIT: 'curSelectedNode_Edit', TMPTARGET_TREE: 'tmpTargetzTree', TMPTARGET_NODE: 'tmpTargetNode'}}, x={onHoverOverNode: function(b, a) {
            let c=m.getSetting(b.data.treeId), d=m.getRoot(c); if (d.curHoverNode!=a)x.onHoverOutNode(b); d.curHoverNode=a; f.addHoverDom(c, a);
...
m.getSetting(b.data.treeId), a=m.getRoot(b); if (a.curHoverNode&&!m.isSelectedNode(b, a.curHoverNode))f.removeTreeDom(b, a.curHoverNode), a.curHoverNode=null;
            ...
            function c(b) {
                if (B.dragFlag==0&&Math.abs(O-b.clientX)<e.edit.drag.minMoveSize&&Math.abs(P-b.clientY)<e.edit.drag.minMoveSize) return !0; let a, c, n, k, i; i=e.data.key.children; M.css('cursor', 'pointer'); if (B.dragFlag==0) {
...
[];
                    ...
                    }n&&(I=l[0].getPreNode(), R=l[l.length-1].getNextNode()); D=o('<ul class=\'zTreeDragUL\'></ul>',
...
h.treeId;)E=E.parentNode; let S=!0; for (a=0, c=l.length; a<c; a++) {
    if (n=l[a], E.id===n.tId) {
        S=!1; break;
...
10); s&&s!=h.treeObj&&s.offset().left<h.treeObj.offset().left&&h.treeObj.scrollLeft(h.treeObj.scrollLeft()+s.offset().left-h.treeObj.offset().left);
    ...
    let z=u==null?null:m.getNodeCache(h, u); i=(b.ctrlKey||b.metaKey)&&e.edit.drag.isMove&&e.edit.drag.isCopy||!e.edit.drag.isMove&&e.edit.drag.isCopy; k=!!(I&&u===I.tId); F=!!(R&&u===R.tId); j=n.parentTId&&n.parentTId==u; n=(i||!F)&&g.apply(h.edit.drag.prev, [h.treeId, l, z],
!!h.edit.drag.prev); k=(i||!k)&&g.apply(h.edit.drag.next, [h.treeId, l, z], !!h.edit.drag.next); i=(i||!j)&&!(h.data.keep.leaf&&!z.isParent)&&g.apply(h.edit.drag.inner, [h.treeId, l, z], !!h.edit.drag.inner); j=function() {
...
(y=!0, window.zTreeMoveTimer&&window.zTreeMoveTargetNodeTId!==z.tId?(clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId=null):window.zTreeMoveTimer&&window.zTreeMoveTargetNodeTId===z.tId&&(y=!1), y)) {
...
null; G.unbind('mousemove', c); G.unbind('mouseup', r); G.unbind('selectstart', k); M.css('cursor', 'auto'); s&&(s.removeClass(d.node.TMPTARGET_TREE), u&&v('#'+u+d.id.A, s).removeClass(d.node.TMPTARGET_NODE+'_'+d.move.TYPE_PREV).removeClass(d.node.TMPTARGET_NODE+'_'+J.move.TYPE_NEXT).removeClass(d.node.TMPTARGET_NODE+'_'+J.move.TYPE_INNER)); g.showIfameMask(e, !1); t.showHoverDom=!0; if (B.dragFlag!=0) {
    B.dragFlag=0; let a, i, j; for (a=0, i=l.length; a<i; a++) {
        j=l[a], j.isParent&&B.dragNodeShowBefore[j.tId]&&!j.open&&(f.expandCollapseNode(e,
j, !j.open), delete B.dragNodeShowBefore[j.tId]);
    }D&&D.remove(); A&&A.remove(); let p=(b.ctrlKey||b.metaKey)&&e.edit.drag.isMove&&e.edit.drag.isCopy||!e.edit.drag.isMove&&e.edit.drag.isCopy; !p&&s&&u&&l[0].parentTId&&u==l[0].parentTId&&w==d.move.TYPE_INNER&&(s=null); if (s) {
        let q=u==null?null:m.getNodeCache(h, u); if (g.apply(e.callback.beforeDrop, [h.treeId, l, q, w, p], !0)==!1)f.selectNodes(x, l); else {
            let C=p?g.clone(l):l; a=function() {
                if (K) {
...
f.addNodes(h, q, -1, C):f.addNodes(h, q.getParentNode(), w==d.move.TYPE_PREV?q.getIndex():q.getIndex()+1, C);
            ...
            w==d.move.TYPE_INNER&&g.canAsync(h, q)?f.asyncNode(h, q, !1, a):a();
                ...
                return !1;
            } var i, j, e=m.getSetting(b.data.treeId), B=m.getRoot(e), t=m.getRoots(); if (b.button==2||!e.edit.enable||!e.edit.drag.isCopy&&!e.edit.drag.isMove) return !0; var p=b.target, q=m.getRoot(e).curSelectedList, l=[]; if (m.isSelectedNode(e, a)) {
                for (i=0, j=q.length; i<j; i++) {
                    if (q[i].editNameFlag&&g.eqs(p.tagName, 'input')&&p.getAttribute('treeNode'+
d.id.INPUT)!==null) return !0; l.push(q[i]); if (l[0].parentTId!==q[i].parentTId) {
    l=[a]; break;
}
                }
...
v.fn.zTree._z, {tools: {getAbs: function(b) {
    ...
    if (b.setSelectionRange)b.focus(), b.setSelectionRange(a, a); else if (b.createTextRange) {
        let c=b.createTextRange();
        c.collapse(!0); c.moveEnd('character', a); c.moveStart('character', a); c.select();
    }
}, showIfameMask: function(b, a) {
    for (var c=m.getRoot(b); c.dragMaskList.length>0;)c.dragMaskList[0].remove(), c.dragMaskList.shift(); if (a) {
        for (let d=o('iframe', b), f=0, i=d.length; f<i; f++) {
            var j=d.get(f), e=g.getAbs(j), j=o('<div id=\'zTreeMask_'+f+'\' class=\'zTreeMask\' style=\'top:'+e[1]+'px; left:'+e[0]+'px; width:'+j.offsetWidth+'px; height:'+j.offsetHeight+'px;\'></div>', b); j.appendTo(o('body', b)); c.dragMaskList.push(j);
        }
    }
}}, view: {addEditBtn: function(b,
a) {
    if (!(a.editNameFlag||o(a, d.id.EDIT, b).length>0)&&g.apply(b.edit.showRenameBtn, [b.treeId, a], b.edit.showRenameBtn)) {
        let c=o(a, d.id.A, b), r='<span class=\''+d.className.BUTTON+' edit\' id=\''+a.tId+d.id.EDIT+'\' title=\''+g.apply(b.edit.renameTitle, [b.treeId, a], b.edit.renameTitle)+'\' treeNode'+d.id.EDIT+' style=\'display:none;\'></span>'; c.append(r); o(a, d.id.EDIT, b).bind('click', function() {
    ...
    addRemoveBtn: function(b, a) {
        if (!(a.editNameFlag||o(a, d.id.REMOVE, b).length>0)&&g.apply(b.edit.showRemoveBtn, [b.treeId, a], b.edit.showRemoveBtn)) {
            let c=o(a, d.id.A, b), r='<span class=\''+d.className.BUTTON+' remove\' id=\''+a.tId+d.id.REMOVE+'\' title=\''+g.apply(b.edit.removeTitle, [b.treeId, a], b.edit.removeTitle)+'\' treeNode'+d.id.REMOVE+' style=\'display:none;\'></span>'; c.append(r); o(a, d.id.REMOVE, b).bind('click', function() {
...
a); b.treeObj.trigger(d.event.REMOVE, [b.treeId, a]); return !1;
        ...
        let r=m.getRoot(b), k=b.data.key.name, i=r.curEditNode; if (i) {
        ...
        let c=m.getRoot(b); f.editNodeBlur=!1; if (m.isSelectedNode(b, a)&&c.curEditNode==a&&a.editNameFlag) {
            setTimeout(function() {
                g.inputFocus(c.curEditInput);
            }, 0);
        } else {
            let r=b.data.key.name; a.editNameFlag=!0; f.removeTreeDom(b, a); f.cancelCurEditNode(b); f.selectNode(b, a, !1); o(a, d.id.SPAN, b).html('<input type=text class=\'rename\' id=\''+
a.tId+d.id.INPUT+'\' treeNode'+d.id.INPUT+' >'); let k=o(a, d.id.INPUT, b); k.attr('value', a[r]); b.edit.editNameSelectAll?g.inputSelect(k):g.inputFocus(k); k.bind('blur', function() {
    ...
    return !1;
}); o(a, d.id.A, b).addClass(d.node.CURSELECTED_EDIT); c.curEditInput=k; c.noSelection=
!1; c.curEditNode=a;
        }
    }, moveNode: function(b, a, c, r, k, i) {
        let j=m.getRoot(b), e=b.data.key.children; if (a!=c&&(!b.data.keep.leaf||!a||a.isParent||r!=d.move.TYPE_INNER)) {
            var g=c.parentTId?c.getParentNode():j, t=a===null||a==j; t&&a===null&&(a=j); if (t)r=d.move.TYPE_INNER; j=a.parentTId?a.getParentNode():j; if (r!=d.move.TYPE_PREV&&r!=d.move.TYPE_NEXT)r=d.move.TYPE_INNER; if (r==d.move.TYPE_INNER) {
                if (t)c.parentTId=null; else {
                    if (!a.isParent)a.isParent=!0, a.open=!!a.open, f.setNodeLineIcos(b, a); c.parentTId=a.tId;
                }
            } let p;
            t?p=t=b.treeObj:(!i&&r==d.move.TYPE_INNER?f.expandCollapseNode(b, a, !0, !1):i||f.expandCollapseNode(b, a.getParentNode(), !0, !1), t=o(a, b), p=o(a, d.id.UL, b), t.get(0)&&!p.get(0)&&(p=[], f.makeUlHtml(b, a, p, ''), t.append(p.join(''))), p=o(a, d.id.UL, b)); let q=o(c, b); q.get(0)?t.get(0)||q.remove():q=f.appendNodes(b, c.level, [c], null, -1, !1, !0).join(''); p.get(0)&&r==d.move.TYPE_INNER?p.append(q):t.get(0)&&r==d.move.TYPE_PREV?t.before(q):t.get(0)&&r==d.move.TYPE_NEXT&&t.after(q); var l=-1, v=0, x=null, t=null, D=c.level;
            if (c.isFirstNode) {
                if (l=0, g[e].length>1)x=g[e][1], x.isFirstNode=!0;
            } else if (c.isLastNode)l=g[e].length-1, x=g[e][l-1], x.isLastNode=!0; else {
                for (p=0, q=g[e].length; p<q; p++) {
                    if (g[e][p].tId==c.tId) {
                    l=p; break;
                }
                }
            }l>=0&&g[e].splice(l, 1); if (r!=d.move.TYPE_INNER) for (p=0, q=j[e].length; p<q; p++)j[e][p].tId==a.tId&&(v=p); if (r==d.move.TYPE_INNER) {
...
(j[e].splice(v, 0, c), t=a, t.isFirstNode=!1, c.parentTId=a.parentTId, c.isFirstNode=!0, c.isLastNode=!1):a.isLastNode&&r==d.move.TYPE_NEXT?(j[e].splice(v+1, 0, c), t=a, t.isLastNode=!1, c.parentTId=a.parentTId, c.isFirstNode=!1, c.isLastNode=!0):(r==d.move.TYPE_PREV?j[e].splice(v, 0, c):j[e].splice(v+1, 0, c), c.parentTId=a.parentTId, c.isFirstNode=!1, c.isLastNode=!1);
            }m.fixPIdKeyValue(b, c); m.setSonNodeLevel(b, c.getParentNode(), c); f.setNodeLineIcos(b, c); f.repairNodeLevelClass(b, c, D); !b.data.keep.parent&&g[e].length<
1?(g.isParent=!1, g.open=!1, a=o(g, d.id.UL, b), r=o(g, d.id.SWITCH, b), e=o(g, d.id.ICON, b), f.replaceSwitchClass(g, r, d.folder.DOCU), f.replaceIcoClass(g, e, d.folder.DOCU), a.css('display', 'none')):x&&f.setNodeLineIcos(b, x); t&&f.setNodeLineIcos(b, t); b.check&&b.check.enable&&f.repairChkClass&&(f.repairChkClass(b, g), f.repairParentChkClassWithSelf(b, g), g!=c.parent&&f.repairParentChkClassWithSelf(b, c)); i||f.expandCollapseParentNode(b, c.getParentNode(), !0, k);
    ...
    removeRemoveBtn: function(b, a) {
        ...
        if (c!==a.level) {
            var f=o(a, b), g=o(a, d.id.A, b), b=o(a, d.id.UL, b), c=d.className.LEVEL+c, a=d.className.LEVEL+a.level; f.removeClass(c); f.addClass(a); g.removeClass(c); g.addClass(a); b.removeClass(c); b.addClass(a);
        }
...
a[c], c>0);
        ...
        if (c) {
            let d=b.data.key.children; c.level=a?a.level+1:0; if (c[d]) for (var a=0, f=c[d].length; a<f; a++)c[d][a]&&m.setSonNodeLevel(b, c, c[d][a]);
        }
    }}}); var I=v.fn.zTree, g=I._z.tools, d=I.consts, f=I._z.view, m=I._z.data, o=g.$; m.exSetting({edit: {enable: !1, editNameSelectAll: !1, showRemoveBtn: !0, showRenameBtn: !0, removeTitle: 'remove', renameTitle: 'rename', drag: {autoExpandTrigger: !1, isCopy: !0, isMove: !0, prev: !0, next: !0, inner: !0, minMoveSize: 5, borderMax: 10, borderMin: -5,
        maxShowNodeNum: 5, autoOpenTime: 500}}, view: {addHoverDom: null, removeHoverDom: null}, callback: {beforeDrag: null, beforeDragOpen: null, beforeDrop: null, beforeEditName: null, beforeRename: null, onDrag: null, onDragMove: null, onDrop: null, onRename: null}}); m.addInitBind(function(b) {
            let a=b.treeObj, c=d.event; a.bind(c.RENAME, function(a, c, d, f) {
            ...
            var b=b.treeObj, a=d.event; b.unbind(a.RENAME); b.unbind(a.DRAG); b.unbind(a.DRAGMOVE); b.unbind(a.DROP);
        }); m.addInitCache(function() {}); m.addInitNode(function(b, a, c) {
            if (c)c.isHover=!1, c.editNameFlag=!1;
        }); m.addInitProxy(function(b) {
        let a=b.target, c=m.getSetting(b.data.treeId), f=b.relatedTarget, k='', i=null, j='', e=null, o=null; if (g.eqs(b.type, 'mouseover')) {
            if (o=g.getMDom(c, a, [{tagName: 'a',
                attrName: 'treeNode'+d.id.A}]))k=g.getNodeMainDom(o).id, j='hoverOverNode';
        } else if (g.eqs(b.type, 'mouseout'))o=g.getMDom(c, f, [{tagName: 'a', attrName: 'treeNode'+d.id.A}]), o||(k='remove', j='hoverOutNode'); else if (g.eqs(b.type, 'mousedown')&&(o=g.getMDom(c, a, [{tagName: 'a', attrName: 'treeNode'+d.id.A}])))k=g.getNodeMainDom(o).id, j='mousedownNode'; if (k.length>0) {
...
x.onHoverOutNode;
        ...
        var b=m.getRoot(b), a=m.getRoots(); b.curEditNode=null; b.curEditInput=null; b.curHoverNode=null; b.dragFlag=0; b.dragNodeShowBefore=[]; b.dragMaskList=[]; a.showHoverDom=!0;
        ...
        a.cancelEditName=function(a) {
            ...
            if (!b) return null;
            if (a&&!a.isParent&&this.setting.data.keep.leaf&&k===d.move.TYPE_INNER) return null; let j=this, e=g.clone(b); if (!a)a=null, k=d.move.TYPE_INNER; k==d.move.TYPE_INNER?(b=function() {
...
!0), f.editNode(this.setting, a));
    ...
    let O=f.cancelPreSelectedNode; f.cancelPreSelectedNode=function(b, a) {
        for (let c=m.getRoot(b).curSelectedList, d=0, g=c.length; d<g; d++) if (!a||a===c[d]) if (f.removeTreeDom(b, c[d]), a) break; O&&O.apply(f, arguments);
    }; let P=f.createNodes; f.createNodes=function(b, a, c, d, g) {
        P&&P.apply(f, arguments); c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b, d);
    }; let W=f.makeNodeUrl; f.makeNodeUrl=function(b, a) {
        return b.edit.enable?null:W.apply(f, arguments);
    }; let L=f.removeNode; f.removeNode=function(b, a) {
        let c=
m.getRoot(b); if (c.curEditNode===a)c.curEditNode=null; L&&L.apply(f, arguments);
    }; let Q=f.selectNode; f.selectNode=function(b, a, c) {
        let d=m.getRoot(b); if (m.isSelectedNode(b, a)&&d.curEditNode==a&&a.editNameFlag) return !1; Q&&Q.apply(f, arguments); f.addHoverDom(b, a); return !0;
    }; let V=g.uCanDo; g.uCanDo=function(b, a) {
        let c=m.getRoot(b); if (a&&(g.eqs(a.type, 'mouseover')||g.eqs(a.type, 'mouseout')||g.eqs(a.type, 'mousedown')||g.eqs(a.type, 'mouseup'))) return !0; if (c.curEditNode)f.editNodeBlur=!1, c.curEditInput.focus();
