...
(function($) {
    ...
    let _initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
	...
	// update zTreeObj, add method of exLib
        _zTreeTools = function(setting, zTreeTools) {
            ...
            let _checkNode = zTreeTools.checkNode;
            if (_checkNode) {
        ...
        _data = {
            ...
            initShowForExCheck: function(setting, n) {
                if (!n.isHidden && setting.check && setting.check.enable) {
                    ...
                    if (view.setChkClass) {
                        let checkObj = $$(n, consts.id.CHECK, setting);
            ...
            showNodes: function(setting, nodes, options) {
                ...
                for (i=0, j=nodes.length; i<j; i++) {
                    ...
                    if (!pList[n.parentTId]) {
                        let pn = n.getParentNode();
                        pList[n.parentTId] = (pn === null) ? data.getRoot(setting) : n.getParentNode();
                    }
                    view.showNode(setting, n, options);
                }
                for (let tId in pList) {
                    let children = pList[tId][setting.data.key.children];
...
//	Override method in core
    ...
    let _makeChkFlag = data.makeChkFlag;
    if (!!_makeChkFlag) {
    ...
    let _getTreeCheckedNodes = data.getTreeCheckedNodes;
    ...
    let _getTreeChangeCheckedNodes = data.getTreeChangeCheckedNodes;
    ...
    let _expandCollapseSonNode = view.expandCollapseSonNode;
    ...
    let _setSonNodeCheckBox = view.setSonNodeCheckBox;
    ...
    let _repairParentChkClassWithSelf = view.repairParentChkClassWithSelf;
