(function() {
    let w = this, d = document, version = '1.0.7', data = {}, length = 0, cbkLen = 0;
    if (w.jsLoader) {
    ...
    ;
    let addEvent = function(obj, eventType, func) {
        if (obj.attachEvent) {
    ...
    let domReady = false, ondomReady = function() {
            domReady = true;
        };
    if (d.addEventListener) {
        let webkit = navigator.userAgent.match(/AppleWebKit\/(\d+)/);
