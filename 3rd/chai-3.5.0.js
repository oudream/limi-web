 ...
 */
            ...
            let config = require('./chai/template_config');
 ...
 */
            ...
            let config = require('./template_config');
  ...
  /**
   * ### template_config.includeStack
   *
   * User configurable property, influences whether stack trace
   * is included in Assertion error message. Default of false
   * suppresses stack trace in the error message.
   *
   *     chai.template_config.includeStack = true;  // enable stack on error
   *
   * @param {Boolean}
   * @api public
   */
  ...
  /**
   * ### template_config.truncateThreshold
   *
   ...
   * inspectable.
   *
   *     chai.template_config.truncateThreshold = 0;  // disable truncating
   *
   * @param {Number}
   * @api public
   */
 ...
 */
   ...
   */
    ...
    // Has any
                  if (any) {
                      let intersection = expected.filter(function(key) {
   ...
   */
      ...
      // next, check message
                      let message = 'error' === _.type(err) && 'message' in err
        ? err.message
        : '' + err;
 ...
 */
   ...
   */
              ...
              let assert = chai.assert = function(express, errmsg) {
                  let test = new Assertion(null, null, chai.assert);
                  test.assert(
        express
      , errmsg
   ...
   */
              ...
              assert.equal = function(act, exp, msg) {
                  let test = new Assertion(act, msg, assert.equal);
   ...
   */
              ...
              assert.notEqual = function(act, exp, msg) {
                  let test = new Assertion(act, msg, assert.notEqual);
   ...
   */
              ...
              assert.throws = function(fn, errt, errs, msg) {
                  ...
                  let assertErr = new Assertion(fn, msg).to.throw(errt, errs);
...
// Check whether `__proto__` is supported
        let hasProtoSupport = '__proto__' in Object;

// Without `__proto__` support, this module will need to add properties to a function.
// However, some Function.prototype methods cannot be overwritten,
// and there seems no easy cross-platform way to detect them (@see chaijs/chai/issues/69).
        let excludeNames = /^(?:length|name|arguments|caller)$/;
  ...
  // save the methods so we can overwrite them later, if we need to.
        ...
        // Use `__proto__` if available
          ...
          // Inherit all properties from the object by replacing the `Function` prototype
                    let prototype = assert.__proto__ = Object.create(this);
 ...
 */
    ...
    module.exports = function(func) {
        ...
        let match = /^\s?function ([^(]*)\(/.exec(func);
 ...
 */
    ...
    let hasProperty = require('./hasProperty');
